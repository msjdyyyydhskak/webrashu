              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*HEY WELCOME TO THE QUEEN RASHU MD BOT 👋🏼*

*THANKS FOR USING 𝙌𝙐𝙀𝙀𝙉 𝙍𝘼𝙎𝙃𝙐 𝙈𝘿" YOUR SESSION HAS BEEN SUCCESSFULLY...!*
...
*📍BOT UPDATE :*
*REPISITY...🧚*
*https://github.com/CyberRushModz0/Queen-Rashu-Md-V2-update*
...
contextInfo: {
externalAdReply: {
title: "🕊️⃝ Qᴜᴇᴇɴ ʀᴀꜱʜᴜ ᴍᴅ 💥",
thumbnailUrl: "https://files.catbox.moe/cpu3eu.jpg",
